...
def get_current_trap_3d():
    ...
    # trap, params = cylindrical_trap.CylindricalTrap(a=R, z0=R, pts=100), TrapVisParams(dist=2.5)
    ...
    # trap, params = open_compensated.OpenCompensatedCylindricalTrap(a=1.0239 * R, z0=R, dzc=0.8351 * R, ze=4.327 * R, pts=100), TrapVisParams(dist=50)
    # trap, params = dhc_trap.DHCTrap(a=R, z0=2*R, beta=0.9, pts=200), TrapVisParams(dist=4)
